 const vagas = {
    ...
    'Analista de Suporte Técnico': {
      descricao:
        'Analista de Suporte Técnico é responsável por prestar suporte e atendimento aos usuários da empresa, solucionando problemas em hardware, software e redes. O profissional deve ter habilidades em atendimento ao cliente, diagnóstico de problemas e conhecimentos técnicos em TI.',
    ...
    'Desenvolvedor de Realidade Virtual': {
      descricao:
        'Desenvolvedor de Realidade Virtual é responsável por criar experiências e aplicações em ambiente de realidade virtual. Utiliza linguagens como C# ou C++, e engines como Unity ou Unreal Engine. O profissional deve ter habilidades em programação, design de interação e conhecimentos em realidade virtual.',
      linguagens: ['C#', 'C++', 'Python'],
